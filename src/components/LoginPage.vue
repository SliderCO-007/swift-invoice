...
const { loading, error, login, googleLogin } = useAuth();
...
// Watch the currentUser ref, which is the single source of truth
        ...
        <fieldset :disabled="loading" class="form-fieldset">
          ...
          <div class="form-group password-group" style="position: relative;">
            <label for="password">Password</label>
             <router-link to="/reset-password" class="forgot-password">Forgot?</router-link>
