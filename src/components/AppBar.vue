    ...
    <v-container class="app-bar-container d-flex align-center">
      <v-toolbar-title>
        <router-link to="/" class="d-flex align-center text-decoration-none text--primary">
          ...
          <span class="font-weight-bold ml-2 d-none d-sm-inline" style="font-size: 1.25rem;">Swift Invoice</span>
        </router-link>
      </v-toolbar-title>
        ...
        <div v-else-if="isAuthenticated && user">
          <v-menu offset-y>
            ...
            <v-list>
              ...
              <v-divider></v-divider>
              <v-list-item v-for="(item, i) in authNav" :key="i" :to="item.to" @click="drawer = false">
        ...
        <v-menu v-if="!loading" offset-y>
          ...
          <v-list>
            ...
            <div v-if="!isAuthenticated">
              ...
              <v-list-item>
                <v-btn block outlined color="primary" to="/register" class="font-weight-bold">Register</v-btn>
              </v-list-item>
            </div>
