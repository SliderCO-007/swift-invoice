...
exports.sendWelcomeEmail = onDocumentCreated({ document: "users/{userId}" }, async (event) => {
    ...
    try {
        ...
        let subject = "Welcome to ScanGo Invoice! 🚀";
        let htmlContent = "";
        ...
        if (userRole === "member") {
            ...
            htmlContent = `
                <div style="font-family: 'Inter', Helvetica, sans-serif; max-width: 600px; margin: 0 auto; background-color: #111d2f; color: #ffffff; padding: 40px; border-radius: 12px; border: 1px solid #1e293b;">
                    <h1 style="color: #60a5fa; margin-bottom: 24px;">Welcome to the Team! 🚀</h1>
                    <p style="font-size: 16px; line-height: 1.6; color: #e2e8f0;">
                        Hi ${userName},
                    </p>
                    <p style="font-size: 16px; line-height: 1.6; color: #e2e8f0;">
                        You have been added as a team member to your organization on <strong>ScanGo Invoice</strong>. We're excited to have you on board!
                    </p>
                    
                    <div style="background-color: #1e293b; padding: 24px; border-radius: 8px; margin: 32px 0;">
                        <h2 style="color: #f8fafc; font-size: 18px; margin-top: 0; margin-bottom: 16px;">Here's how to get started:</h2>
                        <ul style="color: #cbd5e1; font-size: 15px; line-height: 1.8; margin: 0; padding-left: 20px;">
                            <li>📋 <strong>View Assigned Projects:</strong> Land directly on the Projects dashboard to see active campaigns and workloads.</li>
                            <li>⏱️ <strong>Log Billable Hours:</strong> Log your time spent on tasks inside each project to keep invoices accurate.</li>
                            <li>📷 <strong>Track Expenses:</strong> Upload expense receipt images directly to projects on the go.</li>
                            <li>🚀 <strong>Stay Synchronized:</strong> Your logged hours and receipt expenses are automatically made available to the organization owner for client billing.</li>
                        </ul>
                    </div>

                    <p style="font-size: 16px; line-height: 1.6; color: #e2e8f0; margin-bottom: 32px;">
                        Ready to track your first task?
                    </p>

                    <div style="text-align: center;">
                        <a href="https://scangoinvoice.com/projects" style="display: inline-block; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                            Go to Your Projects
                        </a>
                    </div>
